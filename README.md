    ...
    <script>
        (function() {
            ...
            const quizData = [
                ...
                { question: "Какое направление подготовки на факультете СТФ напрямую связано с объектами, которые уже эксплуатируются, и включает в себя задачи по их обследованию, ремонту и предотвращению аварий?", options: ["СУЗ", "ПГС", "АД", "Все перечисленные"], correct: 1 },
